...
public enum UserStatusEnum {
    UNACTIVED(0,"Chưa kích hoạt"),
    NEW_CUSTOMER(1,"Khách hàng mới"),
    LOYAL_CUSTOMER(2, "Khách hàng quen thuộc"),
    VIP_CUSTOMER(3, "Khách hàng VIP"),
    OLD_CUSTOMER(4, "Khách hàng cũ");
